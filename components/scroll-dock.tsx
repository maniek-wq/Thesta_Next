    ...
    >
      ...
      >
        <a
          href={TEL_HREF}
          title={t("dock.call")}
          className="inline-flex min-h-10 min-w-0 items-center justify-center truncate bg-[#2a9d6f] px-1 py-2 text-center text-[10px] font-semibold leading-tight text-sea-950 hover:bg-[#34a878] active:bg-[#2a9d6f] sm:px-2.5 sm:text-sm"
        >
          {t("dock.call")}
        </a>
        <Link
          href="/contact"
          title={t("dock.book")}
          className="inline-flex min-h-10 min-w-0 items-center justify-center truncate border border-bridge/45 bg-transparent px-1 py-2 text-center text-[10px] font-medium leading-tight text-white hover:border-bridge hover:bg-sea-800/40 sm:px-2.5 sm:text-sm"
        >
          {t("dock.book")}
        </Link>
        <Link
